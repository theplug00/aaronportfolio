      ...
      <div className="mx-auto max-w-7xl px-6 py-28 md:px-10 md:py-40">
        <div className="mb-14 md:mb-20">
          ...
          <div className="flex flex-wrap items-end justify-between gap-8">
            <h2 className="font-display text-[clamp(2.4rem,6vw,4.6rem)] font-semibold leading-[0.98] tracking-tight">
              ...
              <Reveal delay={120}>
                <span className="text-outline-cream">Zero surprises.</span>
              </Reveal>
            </h2>
        ...
        <div className="relative">
          {phases.map((ph, i) => (
            ...
            >
              <div
                className={`grid gap-8 rounded-[22px] border border-white/10 bg-gradient-to-br from-[#1a1a1a] to-[#0a0a0a] p-8 shadow-[0_-24px_60px_rgba(0,0,0,0.5)] md:grid-cols-12 md:gap-10 md:p-14 ${
              ...
              >
                ...
                <div className="md:col-span-5">
                  ...
                  <p className="mt-5 max-w-md leading-relaxed text-[#9a9a96]">{ph.body}</p>
                </div>
                <ul className="space-y-4 self-center md:col-span-4">
                  {ph.points.map((pt) => (
                    <li key={pt} className="flex items-start gap-4 border-t border-white/10 pt-4">
                      <svg viewBox="0 0 24 24" className="mt-0.5 h-4 w-4 shrink-0 text-[#c9c9c4]" fill="none" aria-hidden="true">
